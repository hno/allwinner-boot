...
#define  EGON2_SWI_PMU_EXTRA_BASE               0xD0
#define  EGON2_SWI_PMU_INT_EN					(EGON2_SWI_BASE + EGON2_SWI_PMU_EXTRA_BASE + 0x00)
#define  EGON2_SWI_PMU_INT_DIS					(EGON2_SWI_BASE + EGON2_SWI_PMU_EXTRA_BASE + 0x01)
#define  EGON2_SWI_PMU_INT_QUERY				(EGON2_SWI_BASE + EGON2_SWI_PMU_EXTRA_BASE + 0x02)
#define  EGON2_SWI_PMU_LIMIT_PC					(EGON2_SWI_BASE + EGON2_SWI_PMU_EXTRA_BASE + 0x03)
#define  EGON2_SWI_PMU_LIMIT_DC					(EGON2_SWI_BASE + EGON2_SWI_PMU_EXTRA_BASE + 0x04)
