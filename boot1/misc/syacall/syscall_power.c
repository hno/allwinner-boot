...
************************************************************************************************************
*/
int wBoot_power_int_enable(__u8 *addr)
{
	int ret;

	asm("stmfd sp!, {lr}");
	asm("swi %0"::"Ir"(EGON2_SWI_PMU_INT_EN));
	asm("mov %0, r0":"=r"(ret));
	asm("ldmfd sp!, {lr}");
...
************************************************************************************************************
*/
int wBoot_power_int_disable(void)
{
	int ret;

	asm("stmfd sp!, {lr}");
	asm("swi %0"::"Ir"(EGON2_SWI_PMU_INT_DIS));
	asm("mov %0, r0":"=r"(ret));
	asm("ldmfd sp!, {lr}");
...
************************************************************************************************************
*/
int wBoot_power_int_query(void)
{
	int ret;

	asm("stmfd sp!, {lr}");
	asm("swi %0"::"Ir"(EGON2_SWI_PMU_INT_QUERY));
	asm("mov %0, r0":"=r"(ret));
	asm("ldmfd sp!, {lr}");
...
************************************************************************************************************
*/
int wBoot_power_limit_todc(void)
{
	int ret;

	asm("stmfd sp!, {lr}");
	asm("swi %0"::"Ir"(EGON2_SWI_PMU_LIMIT_DC));
	asm("mov %0, r0":"=r"(ret));
	asm("ldmfd sp!, {lr}");
...
************************************************************************************************************
*/
int wBoot_power_limit_topc(void)
{
	int ret;

	asm("stmfd sp!, {lr}");
	asm("swi %0"::"Ir"(EGON2_SWI_PMU_LIMIT_PC));
	asm("mov %0, r0":"=r"(ret));
	asm("ldmfd sp!, {lr}");
