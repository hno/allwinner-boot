...
extern   HIMAGE 		Img_Open		(unsigned int start);
...
extern   unsigned int 	Img_GetItemStart(HIMAGE hImage, HIMAGEITEM hItem);

extern   unsigned int 	Img_ReadItem	(HIMAGE hImage, HIMAGEITEM hItem, void *buffer, unsigned int buffer_size);
